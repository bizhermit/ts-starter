...
export type ElectronAccessor = {
  ...
  setLayoutColor: (color: LayoutColor) => Promise<LayoutColor>;
  getLayoutColor: () => LayoutColor;
  setLayoutDesign: (design: LayoutDesign) => Promise<LayoutDesign>;
  getLayoutDesign: () => LayoutDesign;
